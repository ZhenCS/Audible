...
void *mem_init();
sf_footer *getFooterPointer(sf_header *header);
sf_header *getHeaderPointer(sf_footer *footer);
sf_header *getNextHeaderPointer(sf_header *header);
...
int splitBlock(sf_header *header, size_t oldSize);
